...
let input_channel_params = {
  ...
  "send-aux-3": 27,
  "pan-aux-3": 28,
  "trim": 29 // MAIN OUTPUT BUS PARAMETERS : sent to channel 9
...
let main_output_bus_params = {
  ...
  "compressor-release-time": 19,
  "compressor-ratio": 20,
  "compressor-makeup-gain": 21 // MISC. PARAMETERS (REVERB/SURROUND/AUXES) : sent to channel 10
...
let misc_params = {
  ...
  "aux-2-mute": 26,
  "aux-3-out": 27,
  "aux-3-mute": 28 // CHANGING PRESETS WITH PROGRAM CHANGE MESSAGES sent to any channel on  K-Mix Audio Control port
