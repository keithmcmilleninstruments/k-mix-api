var KMIX = (function () {
	...
	function arraysToObject(values, names){
		return lodash.exports.zipObject(names, values)
	}
	...
	*/
	...
	function findControl(value, eventType, bank, options){
		return lodash.exports.findKey(options, function(o) {
			return findIndex(eventType, o.type) != -1 && isEqual(o[bank], value);
		});
	}

	function findIndex(value, array){
		return lodash.exports.indexOf(array, value);
	}

	function findBank(banks, channel, options){
		return banks[lodash.exports.indexOf(options['midi-channels'], channel + 1)];
	}
	...
	function controlMessage(control, value, messageType = 'input'){
		...
		return lodash.exports.without(message, undefined, null);
	}
	...
	function midiMessageHandler(event, device){
		...
		if(device._debug){
			...
			if(port === 'K-Mix Audio Control'){
				debugLog = lodash.exports.omit(debugLog, 'control:');
	...
	function help(options, request){
		switch(request){
			...
			case 'control':
				...
				console.table(lodash.exports.omit(options, 'midi-channels')); // omit type
				break;
		}
	}
	...
	class KMIX extends EventEmitter {
		constructor(midi, userOptions = {}, debug = false){
			...
			this.banks = lodash.exports.initial(names);

			let newOptions = convertOptions(userOptions, names);
			// make options
			this.options = lodash.exports.merge(KMIXDefaults, newOptions);
			// make devices object
			this.devices = midiPorts_1(this.midi, deviceData);
